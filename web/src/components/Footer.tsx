  ...
  return (
    <footer className="w-full bg-gradient-to-br from-indigo-100/60 to-white/60 dark:from-gray-800/60 dark:to-gray-900/60 backdrop-blur-md border-t border-indigo-100/40 dark:border-gray-700/40 mt-auto transition-colors duration-300">
      <div className="max-w-6xl mx-auto px-2 sm:px-4 py-8 sm:py-10 flex flex-col md:flex-row items-center md:items-start justify-between gap-6 sm:gap-8 w-full">
        {/* Navigation */}
        <nav className="flex flex-col md:flex-row gap-3 sm:gap-6 md:gap-8 text-gray-600 dark:text-gray-300 font-medium text-sm sm:text-base items-center">
          <Link href="/about" className="flex items-center gap-1 hover:text-indigo-500 dark:hover:text-purple-400 transition-colors duration-200"><InformationCircleIcon className="w-5 h-5" /> {t('navigation.about')}</Link>
          <Link href="/contact" className="flex items-center gap-1 hover:text-indigo-500 dark:hover:text-purple-400 transition-colors duration-200"><ChatBubbleLeftRightIcon className="w-5 h-5" /> {t('navigation.contact')}</Link>
        </nav>
        {/* Socials */}
        <div className="flex gap-3 sm:gap-4 mt-4 md:mt-0 text-gray-600 dark:text-gray-300">
          <a href="#" aria-label="Twitter" className="hover:text-indigo-500 dark:hover:text-purple-400 transition-colors duration-200"><svg className="w-5 h-5 sm:w-6 sm:h-6" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24"><path d="M8 19c11 0 13-9 13-13v-.6A9.3 9.3 0 0 0 23 3a9.1 9.1 0 0 1-2.6.7A4.5 4.5 0 0 0 22.4.4a9.1 9.1 0 0 1-2.9 1.1A4.5 4.5 0 0 0 16.1 0c-2.5 0-4.5 2-4.5 4.5 0 .4 0 .8.1 1.2A12.8 12.8 0 0 1 3 1.1a4.5 4.5 0 0 0-.6 2.3c0 1.6.8 3 2.1 3.8A4.5 4.5 0 0 1 2 6.1v.1c0 2.2 1.6 4 3.7 4.4a4.5 4.5 0 0 1-2 .1c.6 1.8 2.3 3.1 4.3 3.1A9.1 9.1 0 0 1 2 17.5c-.6 0-1.2-.1-1.7-.2A12.8 12.8 0 0 0 8 19" /></svg></a>
      ...
      <div className="text-center text-xs sm:text-sm text-gray-400 dark:text-gray-500 py-3 sm:py-4 border-t border-indigo-100/40 dark:border-gray-700/40 mt-4 sm:mt-6 w-full transition-colors duration-300">
