...
export default function EventsPage() {
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900">
      ...
      {/* Left Sidebar */}
      <div className="w-64 bg-white dark:bg-gray-800 border-r border-gray-200 dark:border-gray-700 fixed left-0 top-16 bottom-0 overflow-y-auto">
        <div className="p-6">
          <nav className="space-y-3">
            <button
              onClick={() => router.push('/dashboard')}
              className="w-full flex items-center px-4 py-3 text-left rounded-lg transition-all duration-200 text-gray-700 dark:text-gray-300 hover:bg-gradient-to-r hover:from-gray-50 hover:to-indigo-50/30 dark:hover:from-gray-800/50 dark:hover:to-indigo-900/10 hover:translate-x-1 border-l-4 border-transparent"
            >
            ...
            <button
              onClick={() => router.push('/dashboard')}
              className="w-full flex items-center px-4 py-3 text-left rounded-lg transition-all duration-200 text-gray-700 dark:text-gray-300 hover:bg-gradient-to-r hover:from-gray-50 hover:to-purple-50/30 dark:hover:from-gray-800/50 dark:hover:to-purple-900/10 hover:translate-x-1 border-l-4 border-transparent"
            >
            ...
            <button
              onClick={() => router.push('/dashboard')}
              className="w-full flex items-center px-4 py-3 text-left rounded-lg transition-all duration-200 text-gray-700 dark:text-gray-300 hover:bg-gradient-to-r hover:from-gray-50 hover:to-pink-50/30 dark:hover:from-gray-800/50 dark:hover:to-pink-900/10 hover:translate-x-1 border-l-4 border-transparent"
            >
            ...
            <button
              ...
              className="w-full flex items-center px-4 py-3 text-left rounded-lg transition-all duration-200 bg-gradient-to-r from-indigo-50 to-purple-50 dark:from-indigo-900/20 dark:to-purple-900/20 text-indigo-600 dark:text-indigo-400 border-l-4 border-indigo-600 dark:border-indigo-400"
            >
            ...
            <button
              onClick={() => router.push('/dashboard')}
              className="w-full flex items-center px-4 py-3 text-left rounded-lg transition-all duration-200 text-gray-700 dark:text-gray-300 hover:bg-gradient-to-r hover:from-gray-50 hover:to-red-50/30 dark:hover:from-gray-800/50 dark:hover:to-red-900/10 hover:translate-x-1 border-l-4 border-transparent"
            >
